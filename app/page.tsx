  ...
  return (
    <div className="space-y-16">
      ...
      <p className="text-xs text-zinc-700">
        This is a learning tool of vidi. It is not affiliated with any other company or organization. All content is generated by the user and is not stored or shared.
      </p>
    </div>
  );
}
